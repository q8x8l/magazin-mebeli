<?php
  ...
  echo '<div class="Пагинация" количество_страниц="' . $количество_страниц . '">';
    ...
    if ($количество_страниц > 1) {
      if (($Страница = $_GET ['страница']) != $количество_страниц) echo '<p class="p1"><span>Показать ещё (например 7-8)</span><span>+</span></p>';
      echo '<p class="p2">';
      if ($Страница > 1) {
        echo '<i></i><a href="' . $q . 'страница=1' . $фильтр . $сортировка . '"><<</a><span class="s1">...</span>';
      }
