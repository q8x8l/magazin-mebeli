<?php
  ...
  } elseif ($бренд = $_GET['бренд']) {
    $q = $домен . 'каталог.php?бренд=' . $бренд . '&';
  }
  if ($индекс) echo '<div class="Пагинация" количество_страниц="' . $количество_страниц . '">';
  ...
  if ($индекс) echo '</div><link rel="stylesheet" href="' . $домен . '../../стили/каталог/пагинация.css">';
?>
