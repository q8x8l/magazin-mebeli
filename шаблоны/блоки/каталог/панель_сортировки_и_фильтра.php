...
<ul class="панель_сортировки_и_фильтра">
  <li>
    ...
    <form>
      ...
      <div class="чекбоксы дерево">
        <?php
          // Попробуем вывести дерево нулевым уровнем
          рекурсия_каталога_для_категорий ('../товары/', $глубина = '', $уровень_запроса_в_базу = 0);
          вывод_категорий                 ($каталог_для_меню, $клас = 'категории_фильтра_каталога', $_GET ['путь'], $внутренний_запрос = 0);
        ?>
      </div>
      <button></button>
      <button>
