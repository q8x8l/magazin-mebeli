<?php
  ...
  // Выведем статус на селекты
    if (($тригеры [0] == 0) and ($тригеры [1] == 1)) echo 'Нет';
    if (($тригеры [0] == 1) and ($тригеры [1] == 0)) echo 'Да' ;
    if (($тригеры [0] == 1) and ($тригеры [1] == 1)) echo 'Все';
    echo ',';
    if (($тригеры [2] == 0) and ($тригеры [3] == 1)) echo 'Нет';
    if (($тригеры [2] == 1) and ($тригеры [3] == 0)) echo 'Да' ;
    if (($тригеры [2] == 1) and ($тригеры [3] == 1)) echo 'Все';
?>
