<?php
  ...
  // Выведем статус на селекты
    if (($тригер_0 [0] == 0) and ($тригер_0 [1] == 1)) {
      echo 'Нет';
    }
    if (($тригер_0 [0] == 1) and ($тригер_0 [1] == 0)) {
      echo 'Да';
    }
    if (($тригер_0 [0] == 1) and ($тригер_0 [1] == 1)) {
      echo 'Все';
    }
    echo ',';
    if (($тригер_1 [0] == 0) and ($тригер_1 [1] == 1)) {
      echo 'Нет';
    }
    if (($тригер_1 [0] == 1) and ($тригер_1 [1] == 0)) {
      echo 'Да';
    }
    if (($тригер_1 [0] == 1) and ($тригер_1 [1] == 1)) {
      echo 'Все';
    }
?>
