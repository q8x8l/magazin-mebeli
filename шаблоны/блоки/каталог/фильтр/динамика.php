<?php
  ...
  // Выведем статус на селекты
    $ответы = ['Нет', 'Да', 'Все'];
            if (($тригеры [0] == 0) and ($тригеры [1] == 1)) echo $ответы [0];
            if (($тригеры [0] == 1) and ($тригеры [1] == 0)) echo $ответы [1];
            if (($тригеры [0] == 1) and ($тригеры [1] == 1)) echo $ответы [2];
    echo ',';
        if (($тригеры [2] == 0) and ($тригеры [3] == 1)) echo $ответы [0];
        if (($тригеры [2] == 1) and ($тригеры [3] == 0)) echo $ответы [1];
        if (($тригеры [2] == 1) and ($тригеры [3] == 1)) echo $ответы [2];
  //
?>
