<?php
  ...
  function рекурсия_каталога_для_категорий ($target, $глубина = '', $уровень_запроса_в_базу = 0) {
      ...
      foreach ($массив_папок as $k => $вложенная_папка)
        {
          ...
          рекурсия_каталога_для_категорий ($вложенная_папка, $глубина, $уровень_запроса_в_базу);
        }
    }
  }
